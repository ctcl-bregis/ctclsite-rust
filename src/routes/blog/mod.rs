...
pub async fn blog_index(tmpl: web::Data<tera::Tera>) -> Result<impl Responder, Error> {
...
pub async fn blog_post(page: web::Path<String>, tmpl: web::Data<tera::Tera>) -> Result<impl Responder, Error> {
