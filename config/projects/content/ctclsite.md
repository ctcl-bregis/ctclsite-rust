...
## ctclsite-rust v2 plan
Due to the codebase becoming more and more of a total mess, I plan to do yet another quick rewrite of the website to have things more organized.

A major change with the website is that the repositories for content and code would be separate. Basically, the "config" directory would become its own repository.